<?php
	...
	function call_frappe_api($endpoint, $data) {
		$server_url = $_SERVER['HTTP_HOST'];
		$url = "https://" . $server_url . "/api/method/" . $endpoint;
	...
	function star_cloudprnt_queue_remove_last_print_job($printerMac)
	{
		...
		// 	$file_content = file_get_contents($filepath2);

		// 	$data = array(
		// 		'order_history' => $file_content
		// 	);
		// }
		...
		call_frappe_api('cloudprnt.print_job.process_order_history_from_php', $data);
