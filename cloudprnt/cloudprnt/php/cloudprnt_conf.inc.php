<?php
	...
	// Définir les chemins en fonction de l'existence du dossier /home/neoffice
	$base_path = '/home/frappe';
	if (is_dir('/home/neoffice')) {
		$base_path = '/home/neoffice';
	}
	
	// STAR_CLOUDPRNT_PRINTER_DATA_SAVE_PATH = Sets a working directory where all printer data can be stored
	define('STAR_CLOUDPRNT_DATA_FOLDER_PATH', $base_path . '/frappe-bench/apps/cloudprnt/cloudprnt/cloudprnt/php/data');
	define('STAR_CLOUDPRNT_PRINTER_DATA_SAVE_PATH', $base_path . '/frappe-bench/apps/cloudprnt/cloudprnt/cloudprnt/php/data/printerdata');
	define('STAR_CLOUDPRNT_PRINTER_PENDING_SAVE_PATH', $base_path . '/frappe-bench/apps/cloudprnt/cloudprnt/cloudprnt/php/data/pending');
	...
	define('STAR_CLOUDPRNT_ADDITIONAL_DATA_INTERVAL', 5);
